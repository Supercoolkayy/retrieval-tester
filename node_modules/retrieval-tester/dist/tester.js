...
function fetchWithMetrics(endpoint, cid, timeout) {
        ...
        function testEndpoint(endpoint) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                for (let i = 0; i <= retries; i++) {
                    ...
                    const metrics = yield fetchWithMetrics(endpoint, cid, timeout);
                    if (!metrics.error) {
                ...
                return Object.assign({ endpoint, status: "Failed", error: lastError, attempts, healthScore: 0 }, bestResult);
            });
        }
        // Concurrency control
